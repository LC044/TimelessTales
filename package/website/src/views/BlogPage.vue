...
const years = ref([
  {
    ...
    articles: [
      { date: '09-29', title: 'TPCC测试方法—benchmarksql', link: 'https://blog.siyuan.ink/post/31' },
      { date: '09-04', title: '绿联NAS+Docker：解锁PaddleOCR高效文字识别新姿势', link: 'https://blog.siyuan.ink/post/30' },
      { date: '07-16', title: 'openGauss通信协议', link: 'https://blog.siyuan.ink/post/29' },
      { date: '07-04', title: 'openGauss-JDBC 调试方法', link: 'https://blog.siyuan.ink/post/27' },
      { date: '06-06', title: '服务器网关切换后域名解析故障排查实录', link: 'https://blog.siyuan.ink/post/26' },
      { date: '05-29', title: 'openGauss事务机制（二）', link: 'https://blog.siyuan.ink/post/25' },
      { date: '05-29', title: 'openGauss事务机制（一）', link: 'https://blog.siyuan.ink/post/24' },
      { date: '05-21', title: 'openGauss编译指南', link: 'https://blog.siyuan.ink/post/23' },
      { date: '05-18', title: 'Motor: Enabling Multi-Versioning for Distributed Transactions on Disaggregated Memory', link: 'https://blog.siyuan.ink/post/22' },
      { date: '05-14', title: '分布式系统中的Paxos协议', link: 'https://blog.siyuan.ink/post/21' },
      { date: '05-13', title: '二叉树的前中后序遍历', link: 'https://blog.siyuan.ink/post/20' },
      // { date: '05-10', title: '留痕使用说明', link: 'https://blog.siyuan.ink/post/19' },
      { date: '05-09', title: '[学习笔记] SPDK NVMe of RDMA', link: 'https://blog.siyuan.ink/post/18' },
      // { date: '04-26', title: '万字长文带你了解微信4.0', link: 'https://blog.siyuan.ink/post/17' },
      { date: '03-29', title: '探究方式', link: 'https://blog.siyuan.ink/post/16' },
      { date: '03-26', title: '基于 PyQt5 实现分组列表滚动吸顶效果', link: 'https://blog.siyuan.ink/post/15' },
      { date: '03-22', title: '基于文件名修改图片的拍摄日期', link: 'https://blog.siyuan.ink/post/14' },
      // { date: '03-20', title: '万字长文带你了解Windows微信', link: 'https://blog.siyuan.ink/post/13' },
    ]
  },
  {
    year: '2024',

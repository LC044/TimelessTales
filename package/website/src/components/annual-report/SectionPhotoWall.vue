...
import { ref, onMounted, computed, onUnmounted, watch, type ComponentPublicInstance } from 'vue';
import { getAnnualReportPhotos } from '@/api/annualReport';
import ReportPage from './ReportPage.vue';
import type { Photo } from '@/types/annualReport';
...
const setPhotoRef = (el: Element | ComponentPublicInstance | null, index: number) => {
